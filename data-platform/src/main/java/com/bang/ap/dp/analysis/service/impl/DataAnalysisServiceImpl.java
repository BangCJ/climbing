...
public class DataAnalysisServiceImpl implements DataAnalysisService {
    ...
    public List<FrequenceInRoomDTO> getFrequenceOfRoomInOneWeek(String id) {
        ...
        for (int i = 1; i < 8 ; i++) {
            ...
            frequenceInRoomDTO.setId(String.valueOf(i));
    ...
    public List<RoomUseTimeDTO> getRoomUsedTimeInOneWeek(String id) {
        ...
        for (int i = 1; i <8 ; i++) {
            ...
            roomUseTimeDTO.setId(String.valueOf(i));
            roomUseTimeDTO.setTime(String.valueOf(i+10));
    ...
    public List<DataChangeDTO>  getDataChangeForFire() {
        ...
        DataChangeDTO dataChangeDTO1=new DataChangeDTO(DPTimeUtil.getCurrentLocalDateTime(DPConstant.DATE_FORMAT),"1","温度");
        DataChangeDTO dataChangeDTO2=new DataChangeDTO(DPTimeUtil.getCurrentLocalDateTime(DPConstant.DATE_FORMAT),"-1","烟雾浓度");
        DataChangeDTO dataChangeDTO3=new DataChangeDTO(DPTimeUtil.getCurrentLocalDateTime(DPConstant.DATE_FORMAT),"1","可燃气体浓度");
        response.add(dataChangeDTO1);
        response.add(dataChangeDTO2);
        response.add(dataChangeDTO3);
    ...
    public List<DataRealTimeDTO> getRealTimeDataForFire() {
        ...
        DataRealTimeDTO dataRealTimeDTO1=new DataRealTimeDTO(DPTimeUtil.getCurrentLocalDateTime(DPConstant.DATE_FORMAT),"11","12","温度");
        DataRealTimeDTO dataRealTimeDTO2=new DataRealTimeDTO(DPTimeUtil.getCurrentLocalDateTime(DPConstant.DATE_FORMAT),"12","13","烟雾浓度");
        DataRealTimeDTO dataRealTimeDTO3=new DataRealTimeDTO(DPTimeUtil.getCurrentLocalDateTime(DPConstant.DATE_FORMAT),"2","3","可燃气体浓度");
        response.add(dataRealTimeDTO1);
        response.add(dataRealTimeDTO2);
        response.add(dataRealTimeDTO3);
    ...
    public TerminalResponseDTO getTerminalInfo() {
        ...
        healthCheckDTO.setHealthyRate("90");
        healthCheckDTO.setUnHealthyRate("10");




        responseDTO.setHealthCheck(healthCheckDTO);
