...
public class ReceiveDataHandler extends SimpleChannelInboundHandler<ByteBuf> {
    ...
    private  void saveDHMonitorInfo(float press,float wave){
        ...
        pressMonirot.setOriginDataTime(DPTimeUtil.getCurrentLocalDateTime(DPConstant.DATE_FORMAT));
        ...
        waveMonitor.setName("震动");
        waveMonitor.setMonitorType("wave");
        waveMonitor.setValue(String.valueOf(wave));
        waveMonitor.setOriginDataTime(DPTimeUtil.getCurrentLocalDateTime(DPConstant.DATE_FORMAT));
